...
if ($gId != 6185091342) { sendMessage($chatId, "• <b>TU NO ERES ADMIN</b>", $message_id);exit();}
if(empty($r_userId)){
...
sendChatAction($chatId, "type");
if ($gId != 6185091342) { sendMessage($chatId, '• <b>TU NO ERES ADMIN CONTACTA A 𝗧𝗫𝗙𝗡𝗫 </b>', $message_id);exit();}
if(empty($r_userId)){
$r_userId = substr($message, 5);}
